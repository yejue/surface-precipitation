"""
Django settings for surface_precipitation_0_6 project.
...
SECRET_KEY = 'ejue)2r2-t704fj#snq&b-l!lrqy3bb0d$k2!si6n8^jz(=t7-'
...
WSGI_APPLICATION = 'surface_precipitation_0_6.wsgi.application'
